...
reservations_data_analyst_agent = Agent(
    ...
    instructions=(
        ...
        "1. **Understand the database structure**: Use the `retrieve_reservationsdb_columns` tool to retrieve a list of all available columns in the reservations database, along with their descriptions. "
        "This will help you understand how to construct the SQL query to retrieve the relevant data.\n\n"
        ...
        "- **report**: A long markdown report with the analysis of the data, including insights, conclusions, and recommendations.\n\n"
    ...
    tools=[execute_sql_query, retrieve_reservationsdb_columns],
    output_type=analyst_output,
)
